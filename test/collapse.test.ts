...
describe("Collapse API", () => {
  describe("collapse()", () => {
    ...
    test("collapses animation simple", () => {
      const result = collapse({
        "animation-name": "spin",
    ...
    test("collapses animation with all properties", () => {
      const result = collapse({
    ...
    test("collapses animation multi-layer", () => {
      const result = collapse({
    ...
    test("collapses animation omitting defaults", () => {
      const result = collapse({
